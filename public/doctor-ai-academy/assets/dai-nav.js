...
(function () {
  ...
  var SITEMAP = [
    {
      ...
      icon: 'F',
      label: 'Fundamentals',
      home: '/doctor-ai-academy/fundamentals/home.html',
      pages: [
        { href: '/doctor-ai-academy/fundamentals/home.html',                                   label: '시리즈 홈' },
        { href: '/doctor-ai-academy/fundamentals/01-doctor-ai-series-landing.html',            label: '소개 · 시리즈 전체 안내' },
        { href: '/doctor-ai-academy/fundamentals/11-doctors-learning-ai-intro.html',           label: '1편 · 의사가 AI를 배워야 하는 이유' },
        { href: '/doctor-ai-academy/fundamentals/12-ai-strengths-and-limits.html',             label: '2편 · AI가 잘하는 일과 못하는 일' },
        { href: '/doctor-ai-academy/fundamentals/13-ai-in-outpatient-workflow.html',           label: '3편 · 외래 전후 AI 활용 5가지 장면' },
        { href: '/doctor-ai-academy/fundamentals/14-safe-medical-prompting.html',              label: '4편 · 안전하게 프롬프트 쓰는 법' },
        { href: '/doctor-ai-academy/fundamentals/15-ai-for-resident-education-and-research.html', label: '5편 · 전공의 교육과 연구에 AI 붙이기' },
        { href: '/doctor-ai-academy/fundamentals/16-ai-tool-comparison.html',                 label: '6편 · ChatGPT·Claude·Gemini 비교' },
        { href: '/doctor-ai-academy/fundamentals/17-ai-for-medical-records.html',             label: '7편 · AI로 의무기록 효율 높이기' },
        { href: '/doctor-ai-academy/fundamentals/18-ai-and-medical-ethics.html',              label: '8편 · 의료 AI와 윤리' },
        { href: '/doctor-ai-academy/fundamentals/19-ai-in-radiology-and-pathology.html',      label: '9편 · 영상의학·병리에서 AI가 하는 일' },
        { href: '/doctor-ai-academy/fundamentals/20-doctors-role-in-ai-era.html',             label: '10편 · AI 시대 의사의 역할' }
      ]
    },
    {
      id: 'prompts',
      icon: 'P',
      label: 'Prompts',
      home: '/doctor-ai-academy/prompts/home.html',
      pages: [
        { href: '/doctor-ai-academy/prompts/home.html',                             label: '시리즈 홈' },
        { href: '/doctor-ai-academy/prompts/01-clinical-prompts-intro.html',        label: '1편 · 상황별 기본 프롬프트 5가지' },
        { href: '/doctor-ai-academy/prompts/02-medical-record-prompts.html',        label: '2편 · 진료기록 자동 정리' },
        { href: '/doctor-ai-academy/prompts/03-patient-explanation-prompts.html',   label: '3편 · 환자 설명문 초안 생성' },
        { href: '/doctor-ai-academy/prompts/04-differential-diagnosis-prompts.html',label: '4편 · 감별진단 목록 생성' },
        { href: '/doctor-ai-academy/prompts/05-consent-form-prompts.html',          label: '5편 · 수술·시술 동의서 초안 생성' }
      ]
    },
    {
      id: 'cases',
      icon: 'C',
      label: 'Cases',
      home: '/doctor-ai-academy/cases/home.html',
      pages: [
        { href: '/doctor-ai-academy/cases/home.html',                      label: '시리즈 홈' },
        { href: '/doctor-ai-academy/cases/01-dm-glucose-control.html',     label: '1편 · 혈당 조절 안 되는 2형 당뇨' },
        { href: '/doctor-ai-academy/cases/02-er-chest-pain.html',          label: '2편 · 응급실 흉통 환자 초기 평가' },
        { href: '/doctor-ai-academy/cases/03-discharge-followup.html',     label: '3편 · 퇴원 후 추적관찰 지침 생성' },
        { href: '/doctor-ai-academy/cases/04-polypharmacy-elderly.html',   label: '4편 · 다약제 복용 고령 환자' },
        { href: '/doctor-ai-academy/cases/05-pediatric-fever-workup.html', label: '5편 · 소아 고열 응급실 감별진단' }
      ]
    },
    {
      id: 'tools',
      icon: 'T',
      label: 'Tools',
      home: '/doctor-ai-academy/tools/home.html',
      pages: [
        { href: '/doctor-ai-academy/tools/home.html',                          label: '시리즈 홈' },
        { href: '/doctor-ai-academy/tools/01-chatgpt-vs-claude.html',          label: '1편 · ChatGPT vs Claude 비교' },
        { href: '/doctor-ai-academy/tools/02-gemini-medical-search.html',      label: '2편 · Gemini와 의료 검색 AI 비교' },
        { href: '/doctor-ai-academy/tools/03-korean-ai-tools.html',            label: '3편 · 국내 AI 도구 현황' },
        { href: '/doctor-ai-academy/tools/04-ai-security-checklist.html',      label: '4편 · 보안·개인정보 체크리스트' },
        { href: '/doctor-ai-academy/tools/05-medical-ai-tools-specialty.html', label: '5편 · 전문과목별 의료 AI 도구' }
      ]
    }
  ];
  ...
  SITEMAP.forEach(function (sec) {
    sec.pages.forEach(function (page) {
      var normalized = page.href.replace(/^\/doctor-ai-academy/, '');
  ...
  var injectHtml = ''
    ...
    +       '<a class="dai-nav-badge" href="/doctor-ai-academy/">' + esc(DAI_NAME) + '</a>'
    ...
    +   '</div>'
    +   '<a href="/doctor-ai-academy/" class="dai-drawer-hub">' + esc(DAI_NAME) + ' 허브로 이동</a>'
