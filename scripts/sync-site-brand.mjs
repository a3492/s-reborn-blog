...
/** 긴 문자열을 먼저 치환 (부분 일치 방지) */
const HTML_REPLACEMENTS = [
  ['S-Reborn Blog Blog', 'S-Reborn Blog'],
  ['Doctor AI Academy — S-Reborn</title>', 'Doctor AI Academy — S-Reborn Blog</title>'],
  ['| S-Reborn Medical AI</title>', '| S-Reborn Blog</title>'],
  ['S-Reborn Medical AI | 의료진을 위한 AI 가이드', 'S-Reborn Blog | 의료진을 위한 AI 가이드'],
  ...
  ['S-Reborn · Medical AI Content Platform', 'S-Reborn Blog · Medical AI Content Platform'],
  [' — S-Reborn</title>', ' — S-Reborn Blog</title>'],
  ['| S-Reborn"', '| S-Reborn Blog"'],
  ['| S-Reborn,', '| S-Reborn Blog,'],
  ['S-Reborn 의사가 배우는', 'S-Reborn Blog 의사가 배우는'],
  ['S-Reborn 로고', 'S-Reborn Blog 로고'],
  ['© 2026 S-Reborn · Doctor AI Academy', '© 2026 S-Reborn Blog · Doctor AI Academy'],
  ['© 2026 S-Reborn ·', '© 2026 S-Reborn Blog ·'],
  ['© 2026 S-Reborn</', '© 2026 S-Reborn Blog</'],
  ['← S-Reborn 홈으로', '← S-Reborn Blog 홈으로'],
  ['alt="S-Reborn"', 'alt="S-Reborn Blog"'],
  ['>S-Reborn</a>', '>S-Reborn Blog</a>'],
  ['<title>Doctor AI | S-Reborn Medical AI</title>', '<title>Doctor AI Academy | S-Reborn Blog</title>'],
