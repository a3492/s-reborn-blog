...
ChatGPT에 같은 질문을 두 번 하면 답이 다르다. 버그가 아니라 **의도된 설계**다.

LLM은 다음 토큰을 예측할 때 **확률 분포**를 계산한다.
...
이 확률 중에서 어떤 토큰을 선택할지를 결정하는 게 **Temperature**다.
...
Temperature와 함께 쓰이는 또 다른 파라미터가 **Top-p**다.
