...
AgentExecutor만 쓰다 로그에 어느 분기를 탔는지 안 남아 박과장이 감사 질문을 못 넘긴다.
...
혜준: “RoundPrep v0.2는 노드와 엣지가 있는 그림부터 커밋합니다.”

### 다음 화

그래프 안에서 에이전트가 서로 말로 협상하게 두려면 — [AutoGen 입문](/blog/orchestration/autogen-intro/)
