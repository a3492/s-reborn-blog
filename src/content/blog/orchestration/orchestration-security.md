...
tags: ["cu", "보안", "오케스트레이션", "프롬프트인젝션", "에이전트보안"]
description: "멀티 에이전트 시스템은 단일 AI보다 더 많은 공격 표면을 갖는다. 오케스트레이션 특유의 보안 위협과 대응 방법을 다룬다."
read_time: 7
...
다음 화: [오케스트레이션 비용 최적화 — AI 여러 개 쓰면 돈이 얼마나 드나](/blog/orchestration/orchestration-cost-optimization/) — 같은 팀이 막혔던 지점에서 이어진다.
