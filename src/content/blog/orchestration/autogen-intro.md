...
tags: ["cu", "AutoGen", "Microsoft", "멀티에이전트", "대화형에이전트"]
description: "Microsoft가 만든 AutoGen은 에이전트들이 자연어로 서로 대화하면서 협력하는 프레임워크다. 어떻게 동작하고 어떤 상황에 맞는지 살펴본다."
read_time: 7
...
다음 화: [CrewAI — 브라질 개발자의 개인 프로젝트가 AI 팀 빌딩의 표준이 된 이야기](/blog/orchestration/crewai-intro/) — 같은 팀이 막혔던 지점에서 이어진다.
