...
tags: ["cu2604021138", "테스트", "품질보증", "오케스트레이션", "Eval"]
description: "RoundPrep 제17화. 다이어그램 다음은 증거다."
read_time: 14
...
**비결정론적이라서 테스트를 안 하는 게 아니라, 다른 종류의 테스트를 해야 한다.**

### 스테이크

박과장이 **증명**을 원한다. “가끔 잘되던데요”는 통과가 안 된다.

### 전환점 — RoundPrep 메모

스테이징에서만 통과하고 **야간 Lab 지연**에서 터진 가상 릴리스.
...
**혜준:** “골든 시나리오 + 회귀 + 메트릭 상한을 **CI에** 넣습니다.”

### 다음 화

테스트가 실패했는데 **어디가 범인인지** — [오케스트레이션 디버깅](/blog/orchestration/orchestration-debugging/)
